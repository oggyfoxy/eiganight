...
define('RECAPTCHA_SITE_KEY_V2', getenv('RECAPTCHA_V2_SITE_KEY') ?: '6LdsyEgrAAAAAEdzcQGufogCHtE2Cx0uWN6XumUV');
define('RECAPTCHA_SECRET_KEY_V2', getenv('RECAPTCHA_V2_SECRET_KEY') ?: 'Y6LdsyEgrAAAAAAFSQ2iSvPyPJJ7Wcz-aYfmgRHT');
